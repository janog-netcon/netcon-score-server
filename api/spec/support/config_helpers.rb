...
module ConfigHelpers
  ...
  def set_configs! # rubocop:disable Metrics/MethodLength
    Config.create!(key: :registration_code,              value_type: :string,  value: SecureRandom.alphanumeric)
    ...
    Config.create!(key: :guide_page_en,                  value_type: :string,  value: Config.guide_page_default_value + Array.new(Random.rand(10..30)) { Faker::Books::Dune.quote }.join("\n"))
