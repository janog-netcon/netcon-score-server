...
def create_config
  ...
  configs = [
    ...
    { key: :guide_page,                     value_type: :string,  value: Config.guide_page_default_value + Array.new(Random.rand(10..30)) { Faker::Books::Dune.quote }.join("\n") },
    { key: :guide_page_en,                  value_type: :string,  value: Config.guide_page_default_value + Array.new(Random.rand(10..30)) { Faker::Books::Dune.quote }.join("\n") },
